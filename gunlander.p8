...
function setpods()
    level.activepods = {}
    for pod in all(level.friendlist) do
        add(level.activepods,createpod(pod[1],pod[2]))
        mset(pod[1],pod[2],0)
    end
end
--podx and y are the tile positions
function createpod(podx,pody)
    pod = {}
    --pods are made of x, y, direction, counter
    pod.x = (podx-level.startx)*8
    pod.y = (pody-level.starty)*8
    pod.c = 0 --counter
    pod.d = flr(rnd(2)) --direction, randome either 0 or 1
    pod.s = 42
return pod
end
-------------------
...
function _draw()
    ...
    if level.number > 0 then
        ...
        foreach(level.activepods, draw_object)
        draw_ship()
...

...

...

